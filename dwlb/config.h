...
// font
static char *fontstr = "JetBrainsMonoNerdFont:size=16:antialias=true,NotoColorEmoji:size=16:antialias=true";
// tag names
...
static pixman_color_t active_bg_color = HEX_COLOR(0xd65d0eff);
...
static pixman_color_t urgent_bg_color = HEX_COLOR(0xebdbb2ff);

static pixman_color_t middle_bg_color = HEX_COLOR(0x282828ff);
static pixman_color_t middle_bg_color_selected = HEX_COLOR(0xd65d0eff);
