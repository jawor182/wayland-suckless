...
static const char *spterm[]        = { "t", "foot", "--title", "spterm", NULL};
static const char *spsound[]       = { "s", "foot", "--title", "pulsemixer","-e","pulsemixer", NULL};
static const char *spbt[]          = { "b", "foot", "--title", "spbt","-e","bluetuith",NULL};
static const char *spnotes[]       = { "n", "foot", "--title", "spnotes","-e","sh","-c","cd ~/dox/notes && $EDITOR", NULL};
static const char *spfiles[]       = { "f", "foot", "--title", "spfiles","-e","yazi", NULL};
static const char *spsysmon[]      = { "m", "foot", "--title", "spsysmon","-e","btop", NULL};
...
static const Key keys[] = {
	...
	{ MODKEY|WLR_MODIFIER_CTRL,  XKB_KEY_b,          togglescratch,  {.v = spbt } },
	...
	{ MODKEY,                    XKB_KEY_b,          spawn,          SHCMD("killall -SIGUSR2 waybar") },
    ...
    { MODKEY,                    XKB_KEY_c,          spawn,          {.v = communicator } },
    ...
    { MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_P,          spawn,          SHCMD("wl-color-picker") },
    { MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_W,          spawn,          SHCMD("imvpaper open")},
    { MODKEY|WLR_MODIFIER_CTRL,  XKB_KEY_w,          spawn,          SHCMD("imvpaper random") },
